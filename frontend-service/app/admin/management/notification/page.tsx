...
export default function NotificationPage() {
  return (
    <div className="space-y-10">
      ...
      <div className="bg-white rounded-[40px] border border-slate-50 shadow-sm p-20 flex flex-col items-center justify-center text-center space-y-6 animate-fade-in">
